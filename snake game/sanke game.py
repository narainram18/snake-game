...
class APPLE:
    ...
    def drawapple(self):
        ...
        #pygame.draw.rect(screen,(166,150,55),apple_rect)
...
class MAIN:
    ...
    def draw_score(self):
        ...
        apple_rect = image.get_rect(midright = (score_rect.left,score_rect.centery))
...
image=pygame.image.load(r'Graphics\apple.png').convert_alpha()
